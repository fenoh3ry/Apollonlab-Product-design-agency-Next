...
import articlesPageInitialPropsTqK8Resource from '../../../resources/articles-page-initial-props-tq_k8'
import articlesPageInitialPathsTqGmResource from '../../../resources/articles-page-initial-paths-tq_gm'
...
export async function getStaticProps(context) {
  try {
    const response = await articlesPageInitialPropsTqK8Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await articlesPageInitialPathsTqGmResource({})

            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                <h2 className="thq-heading-2">
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps2-text29">Step 1: Sign Up</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        Create an account by providing your email and setting up
                        a password.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        Discover all the amazing features and functionalities
                        our platform offers.
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="steps2-container6 thq-card">
                <h2 className="thq-heading-2">
                  {props.step3Title ?? (
                    <Fragment>
                      <span className="steps2-text30">Step 3: Start Using</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        Start enjoying the benefits of our platform and make the
                        most out of it.
                      </span>
                    </Fragment>
                  )}
